...
namespace AeroVeloz.Domain.DomainService.Interfaces.Airline
{
    public interface IAirlineDomainService
    {
        ...
        Task<ValidationResult> ValidateBatchAsync(IEnumerable<AeroVeloz.Domain.Entities.Flight.Flights> batch, string airportName); // ESTA LINEA ES PARA VALIDAR UN LOTE DE VUELO
        ...
        ValidationResult ValidateInFlight(AeroVeloz.Domain.Entities.Flight.Flights flight, FlightStateEnum newState);
        ...
        Task<ValidationResult> ValidateOwnerAsync(string airlineCode, IEnumerable<AeroVeloz.Domain.Entities.Flight.Flights> batch);
        ...
        Task<ValidationResult> ProcessFlightBatchAsync(IEnumerable<AeroVeloz.Domain.Entities.Flight.Flights> batch, string airlineCode, string currentAirport);
